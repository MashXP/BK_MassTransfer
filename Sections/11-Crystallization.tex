...
Crystallization is a specific mass transfer process involving the formation of solid crystals from a homogeneous solution. It is widely used to separate and purify substances.
...
\begin{enumerate}
    \item \textbf{Nucleation:} The birth of new solid particles (nuclei) from the liquid phase. This usually occurs at the metastable limit, which is influenced by factors such as agitation, impurities, and cooling rate.
...
Where:
\begin{itemize}
    \item $\Enthalpy_1$: Enthalpy of the feed solution.
