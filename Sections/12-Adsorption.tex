...
Adsorption is a separation process involving the adhesion of atoms, ions, or molecules from a gas or liquid (fluid phase) to the surface of a solid substance. Common applications include water treatment, gas separation, and chromatography. It is distinct from distillation (which separates based on boiling points).
...
\end{itemize}
Common forms include cylindrical pellets, beads, granules, and powders. Examples include Zeolite (crystalline, uniform pores) and Activated Carbon. Zeolites are superior to non-porous materials like sand because they have a rough texture and large internal surface area/porosity.
...
\end{equation}
A plot of $\log \qe$ vs. $\log \Ce$ yields a slope of $n$ and an intercept of $\log \FreundlichK$. If $n < 1$ (or $1/n > 1$), the adsorption is considered favorable.
...
\begin{itemize}
    ...
    \item Within the MTZ: Adsorption is actively occurring (concentration drops from feed to zero). The concentration profile typically follows an "S" shape (sigmoidal curve).
